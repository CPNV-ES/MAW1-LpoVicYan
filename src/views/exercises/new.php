...
<main class="container">
    ...
    <body>
        ...
        <form action="/exercises" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden"
                value="&#x2713;" /><input type="hidden" name="authenticity_token"
                value="fKJWz2xwmy0CsjZNyAx9IVj1dgX274vMobANwR7EIv0bjFweCGmftjVmtO1R6N35E4ZkfuDhOSpvQ8OsZ8J9pA==" />
