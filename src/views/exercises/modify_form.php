...
<main class="container">
    ...
    <div class="row">
            ...
            <table class="records">
                ...
                foreach ( $data[ 'questions' ] as $field ): ?>
                    <tr>
                        ...
                        <td>
                            <a title="Edit"
                               href="/exercises/<?= $field[ 'exercise_id' ] ?>/fields/<?= $field[ 'id' ] ?>/edit"><i
                                        class="fa fa-edit"></i></a>
                            <a data-confirm="Are you sure?" title="Destroy" rel="nofollow" data-method="delete" href=""/exercises/<?= $field[ 'exercise_id' ] ?>
                            /fields/<?= $field[ 'id' ] ?>/edit"><i class="fa fa-trash"></i></a>
                        </td>
                    </tr>
                <?php
                endforeach; ?>
        ...
        <section class="column">
            <h1>New Field</h1>
            <form action="/exercises/789/fields" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden"
                                                                                             value="&#x2713;"/><input
